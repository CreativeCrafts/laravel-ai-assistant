...
/**
 * @deprecated 3.x Use Ai::chat() which returns ChatSession (modern Responses and Conversations).
 * This class remains for backward compatibility and will be removed in a future major version.
 */
final class Assistant implements AssistantContract
{
    ...
    public function __construct(/* ... keep existing signature ... */)
    {
        Deprecation::maybeOnce(
            key: 'class.Assistant',
            message: 'Assistant is deprecated. Prefer Ai::chat() which returns a ChatSession (modern Responses + Conversations).'
        );
    }
