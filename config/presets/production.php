 ...
 *
 * This preset is optimized for production environments with focus on security,
 * performance, reliability, and monitoring. Includes production-ready defaults
 * with conservative resource usage and comprehensive error handling.
 *
...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Response Generation Parameters (Conservative)
    |--------------------------------------------------------------------------
    */
    ...
    */
    ...
    'responses' => [
        'timeout' => env('AI_RESPONSES_TIMEOUT', 90), // Shorter timeout
    ...
    */
    ...
    'memory_monitoring' => [
        ...
        'threshold_mb' => env('AI_MEMORY_THRESHOLD_MB', 128), // Lower threshold
    ...
    'background_jobs' => [
        ...
        'timeout' => env('AI_JOB_TIMEOUT', 180), // Shorter timeout
